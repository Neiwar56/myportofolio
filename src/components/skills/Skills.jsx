...
import { FaPhp, FaPython, FaReact, FaWordpress } from "react-icons/fa";
import { IoLogoNodejs } from "react-icons/io";
import { FiFigma } from "react-icons/fi";

const Skills = ({ darkMode }) => {
  return (
    <div id="Compétences" className="bg-gradient-to-r from-white to-blue-300">
      <div className=" container m-auto  mt-16">
        ...
        <div className="flex md:flex-col ">
          <div className="left flex-1 w-full">
            ...
            >
              Explorez mon éventail de compétences professionnelles.
            </p>
            {/* left box */}
            <div
              data-aos="zoom-in"
            ...
            >
              <div className=" flex flex-col gap-6  w-3/4  my-5 md:w-[90%]">
                ...
                <ProgressBar logo={<FaPython />} name={"Python"} value={87} />
                <ProgressBar
                  logo={<SiDjango />}
                  name={"Django"}
                  value={65}
